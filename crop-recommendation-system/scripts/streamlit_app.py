...
class CropRecommendationApp:
    ...
    def load_data_info(self):
        ...
        try:
            ...
            # Fallback to default
            self.feature_names = ['N', 'P', 'K', 'temperature', 'ph', 'rainfall']
    ...
    <div class="main-container">
        <div style="text-align: center; padding: 2rem 0;">
            ...
            <div style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                <div class="stat-item">
                    <div style="font-size: 2rem; font-weight: 700; color: #2E8B57;" class="animate-number" data-target="22">0</div>
                    <div style="font-size: 0.9rem; color: #666;">Crop Types</div>
                </div>
                <div class="stat-item">
                    <div style="font-size: 2rem; font-weight: 700; color: #2E8B57;" class="animate-number" data-target="95">0</div>
                    <div style="font-size: 0.9rem; color: #666;">Accuracy %</div>
                </div>
                <div class="stat-item">
                    <div style="font-size: 2rem; font-weight: 700; color: #2E8B57;" class="animate-number" data-target="2200">0</div>
                    <div style="font-size: 0.9rem; color: #666;">Data Points</div>
                </div>
            </div>
        </div>
    </div>
